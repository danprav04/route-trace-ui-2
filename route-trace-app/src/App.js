      ...
      <Box sx={{ display: 'flex', minHeight: '100vh' }}>
        ...
        <Box
          ...
          sx={{
            ...
            display: 'flex', // Enable flex column for content layout
            flexDirection: 'column', // Stack AppBar spacer and Container
            // --- Added for vertical scrolling ---
            height: '100vh', // Ensure main area tries to take full viewport height
        ...
        >
           ...
           {isAuthenticated && (
                <AppBar
                    position="fixed" // Keep mobile AppBar fixed
                    ...
                    sx={{
                        ...
                        zIndex: (theme) => theme.zIndex.drawer + 1, // Ensure it's above the sidebar on mobile
                    }}
                >
                    <Toolbar>
                        <IconButton
             ...
             {/* Add a Toolbar component here to create space below the fixed AppBar
                 ...
                 or if the mobile AppBar exists. Needs to be inside the scrolling Box. */}
            <Toolbar sx={{ display: { xs: 'block', sm: 'none' }, flexShrink: 0 }} /> {/* Spacer for mobile app bar */}

            {/* Page Content Container - Allow this to grow and push footer (if any) down */}
